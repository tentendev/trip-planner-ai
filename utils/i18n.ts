...
export const TRANSLATIONS: Record<Language, typeof BASE_EN> = {
  ...
  'hi': {
    ...
    form: {
      ...BASE_EN.form,
      section_style: 'शैली और बजट',
      section_prefs: 'रुचियाँ और ज़रूरतें',
      travelers: 'सहयात्री',
      travelers_placeholder: 'जैसे, दंपति, 30 के दशक, फिट',
      destination_placeholder: 'जैसे, क्योटो और ओसाका, जापान',
      dates_start: 'आगमन तिथि',
      dates_end: 'प्रस्थान तिथि',
      dates_select: 'तारीख़ चुनें',
      dates_range_error: 'तारीख़ सीमा चुनें',
      arrival_placeholder: 'जैसे, CI156 11:30 KIX पर आगमन',
      departure_placeholder: 'जैसे, CI157 18:30 प्रस्थान',
      budget_placeholder: 'जैसे, कुल 2,000 USD',
      work: 'कार्य / खरीदारी',
      work_placeholder: 'जैसे, काम के लिए कैफ़े चाहिए',
      pace_options: {
        Slow: 'धीमा (आराम)',
        Moderate: 'मध्यम (संतुलित)',
        Fast: 'तेज़ (भरा हुआ)',
        Intense: 'अति-तीव्र (नॉन-स्टॉप)'
      },
  ...
  'ar': {
    ...
    form: {
      ...BASE_EN.form,
      section_style: 'الأسلوب والميزانية',
      section_prefs: 'الاهتمامات والاحتياجات',
      travelers: 'المسافرون',
      travelers_placeholder: 'مثال، زوجان، ثلاثينيات، لائقون',
      destination_placeholder: 'مثال، كيوتو وأوساكا، اليابان',
      dates_start: 'تاريخ البدء',
      dates_end: 'تاريخ الانتهاء',
      dates_select: 'اختر تاريخًا',
      dates_range_error: 'اختر نطاق التواريخ',
      arrival_placeholder: 'مثال، CI156 وصول 11:30 إلى KIX',
      departure_placeholder: 'مثال، CI157 مغادرة 18:30',
      budget_placeholder: 'مثال، إجمالي 2,000 دولار أمريكي',
      work: 'العمل / التسوق',
      work_placeholder: 'مثال، مقهى للعمل',
      pace_options: {
        Slow: 'بطيء (مسترخٍ)',
        Moderate: 'متوسط (متوازن)',
        Fast: 'سريع (مكتظ)',
        Intense: 'مكثف (بلا توقف)'
      },
  ...
  'pt': {
    ...
    form: {
      ...BASE_EN.form,
      section_style: 'Estilo & Orçamento',
      section_prefs: 'Interesses & Necessidades',
      travelers: 'Viajantes',
      travelers_placeholder: 'ex.: Casal, 30 anos, ativos',
      destination_placeholder: 'ex.: Kyoto e Osaka, Japão',
      dates_start: 'Início',
      dates_end: 'Fim',
      dates_select: 'Selecionar Data',
      dates_range_error: 'Selecione o intervalo de datas',
      arrival_placeholder: 'ex.: CI156 chega 11:30 em KIX',
      departure_placeholder: 'ex.: CI157 parte 18:30',
      budget_placeholder: 'ex.: Total 2.000 USD',
      work: 'Trabalho / Compras',
      work_placeholder: 'ex.: Preciso de café para trabalhar',
      pace_options: {
        Slow: 'Lento (Relaxado)',
        Moderate: 'Moderado (Equilibrado)',
        Fast: 'Acelerado (Cheio)',
        Intense: 'Intenso (Sem parar)'
      },
  ...
  'ru': {
    ...
    form: {
      ...BASE_EN.form,
      section_style: 'Стиль и бюджет',
      section_prefs: 'Интересы и потребности',
      travelers: 'Путешественники',
      travelers_placeholder: 'напр., пара, 30–40 лет, в форме',
      destination_placeholder: 'напр., Киото и Осака, Япония',
      dates_start: 'Начало',
      dates_end: 'Конец',
      dates_select: 'Выбрать дату',
      dates_range_error: 'Выберите диапазон дат',
      arrival_placeholder: 'напр., CI156 прибытие 11:30 в KIX',
      departure_placeholder: 'напр., CI157 вылет 18:30',
      budget_placeholder: 'напр., всего 2 000 USD',
      work: 'Работа / Покупки',
      work_placeholder: 'напр., нужно кафе для работы',
      pace_options: {
        Slow: 'Медленный (спокойный)',
        Moderate: 'Умеренный (сбалансированный)',
        Fast: 'Быстрый (плотный)',
        Intense: 'Насыщенный (без остановки)'
      },
